...
logfire.configure(service_name="enterprise-rag-ingestion-service")
#Local folder where parsed and chunked JSON metadata is saved, for dev purpose
...
def save_processed_locally(data: dict, source_type: str, filename: str) -> str:
    #saves parsed chunk metadata as JSON in folder processed_data/source type/...
...
def process_file(file_path: str, filename: str, source_type: str):
    ...
    with logfire.span("Processing File", file=filename, source=source_type):
        try:
            #1.Extract text based on file extension, this is SMART PARSER
